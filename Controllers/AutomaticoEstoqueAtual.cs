...
{
    public class AutomaticoEstoqueAtual : Controller
    {
        ...
        private static string pagina = "DownloadAutomatico.aspx?p=TOOLHOUSE.VW_Estoque_Positivo&id=2";

        private const string SessionKeyLoggedUserInformation = "LoggedUserInformation";

        public AutomaticoEstoqueAtual(ContextoBanco context, ContextoBancoBS contextBS, ContextoBancoRM contextRM, IHttpContextAccessor httpCA, IConfiguration configuration)
        {
            _context = context;
                ...
                if (loggedUser != null)
                {
                    ...
                    if (checkPermission != null)
                    {
                        if (checkPermission.Visualizar == 1)
                        {
                            ...
                            //usuariofer.Retorno = "Acesso Permitido";
                            ...
                            var query = (from e in _context.VW_Estoque_Positivo
                                         select e).ToList();
                            ...
                            dataTable.Columns.Add("SetorOrigem");
                            ...
                            foreach (var item in query)
                            {
                                ...
                                row["SetorOrigem"] = item.SetorOrigem;
        ...
        // GET: AutomaticoEstoqueAtual/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: AutomaticoEstoqueAtual/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AutomaticoEstoqueAtual/Create
        [HttpPost]
        ...
        // GET: AutomaticoEstoqueAtual/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: AutomaticoEstoqueAtual/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AutomaticoEstoqueAtual/Delete/5
        public ActionResult Delete(int id)
        {
            return View();
        }

        // POST: AutomaticoEstoqueAtual/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
