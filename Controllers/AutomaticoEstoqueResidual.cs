...
{
    public class AutomaticoEstoqueResidual : Controller
    {
        ...
        private static string pagina = "DownloadAutomatico.aspx?p=TOOLHOUSE.VW_Estoque_Residual&id=10";

        private const string SessionKeyLoggedUserInformation = "LoggedUserInformation";

        public AutomaticoEstoqueResidual(ContextoBanco context, ContextoBancoBS contextBS, ContextoBancoRM contextRM, IHttpContextAccessor httpCA, IConfiguration configuration)
        {
            _context = context;
                ...
                if (loggedUser != null)
                {
                    ...
                    if (checkPermission != null)
                    {
                        if (checkPermission.Visualizar == 1)
                        {
                            ...
                            var query = (from e in _context.VW_Estoque_Residual
                                         select e).ToList();
        ...
        // GET: AutomaticoEstoqueResidual/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: AutomaticoEstoqueResidual/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AutomaticoEstoqueResidual/Create
        [HttpPost]
        ...
        // GET: AutomaticoEstoqueResidual/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: AutomaticoEstoqueResidual/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AutomaticoEstoqueResidual/Delete/5
        public ActionResult Delete(int id)
        {
            return View();
        }

        // POST: AutomaticoEstoqueResidual/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
